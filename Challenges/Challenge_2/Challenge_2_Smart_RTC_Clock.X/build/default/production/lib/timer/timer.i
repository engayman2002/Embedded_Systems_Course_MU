...
# 2 "<built-in>" 2
# 1 "lib/timer/timer.c" 2
# 1 "lib/timer/timer.h" 1
# 11 "lib/timer/timer.h"
# 1 "lib/timer/../common.h" 1
...
# 7 "lib/timer/../common.h" 2
# 11 "lib/timer/timer.h" 2
...
void timer0_init(char prescaler)
{
    OPTION_REG = (OPTION_REG & 0xF8) | (prescaler & 0x7);
...
unsigned long counter0_get_val()
{
    ...
    overflow_cnt=0;
    GIE =1;
    return ( (curr_ov_cnt* (256)) + curr_cnt_val);
}
