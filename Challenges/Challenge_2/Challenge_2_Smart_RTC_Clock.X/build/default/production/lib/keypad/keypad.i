...
# 2 "<built-in>" 2
# 1 "lib/keypad/keypad.c" 2
# 1 "lib/keypad/keypad.h" 1
# 10 "lib/keypad/keypad.h"
# 1 "lib/keypad/../common.h" 1
...
# 7 "lib/keypad/../common.h" 2
# 10 "lib/keypad/keypad.h" 2
...
unsigned char keypad_get_key(void){
     ...
     if ((PORTB & (1<<4)?1:0) == 0 ){
        while((PORTB & (1<<4)?1:0) == 0);
        return '7' ;
     }else if ((PORTB & (1<<5)?1:0) == 0){
         while((PORTB & (1<<5)?1:0) == 0);
         return '8' ;
     }else if ((PORTB & (1<<6)?1:0) == 0){
         while((PORTB & (1<<6)?1:0) == 0);
         return '9' ;
     }else if ((PORTB & (1<<7)?1:0) == 0){
         while((PORTB & (1<<7)?1:0) == 0);
         return '/' ;
     }
